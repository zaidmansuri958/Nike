...
public class FootballAdapter  extends FirebaseRecyclerAdapter<cardModal,FootballAdapter.viewHolder> {

    public FootballAdapter(@NonNull FirebaseRecyclerOptions<cardModal> options) {
        super(options);
    }
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.footballcard,parent,false);
    ...
    public class  viewHolder extends RecyclerView.ViewHolder {
        ...
        public viewHolder(@NonNull View itemView) {
            ...
            buy=itemView.findViewById(R.id.football_btn);
